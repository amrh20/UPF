...
@Component({
  selector: "app-family-profile-section",
  templateUrl: "./family-profile-section.component.html",
  styleUrls: ["./family-profile-section.component.css"],
})
export class FamilyProfileSectionComponent extends RequestDetailsSectionComponent{
  familyProfileType
  familyProfileIndex
  ...
  openPopUp(type) {
    ...
    this.familyProfileType = type
    this.familyProfileIndex = null
  ...
  edit(type, index, row) {
    ...
    this.familyProfileType = type
    this.familyProfileIndex = index
    this._messageService.filter(obj);
  }

  close() {
    let ind
    if (this.familyProfileIndex == null) {
       if (this.familyProfileType == "familyProfileSegment") {
        ind = this.section.body.details['familyProfileSegment']['familyProfile'].length - 1
      }
    } else {
      ind = this.familyProfileIndex
    }
     if (this.familyProfileType == "familyProfileSegment") {
...
@Component({
  selector: 'app-family-profile-popup',
  templateUrl: './family-profile-details.component.html',
  styleUrls: ["./family-profile-section.component.css"],
})
export class FamilyProfilePopupDetailsComponent  {
