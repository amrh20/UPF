...
export class RequestDetailsSectionComponent implements AfterViewInit {
  ...
  openPopUp(type) {
    ...
    if (type == 'qualificationSegment') {
      row = this.section.body.details.qualificationSegment.qualification[this.section.body.details.qualificationSegment.qualification.length - 1]
    }
    if(type == 'nationalAddressSegment'){
      row = this.section.body.details.nationalAddressSegment.nationalAddress[this.section.body.details.nationalAddressSegment.nationalAddress.length - 1]
    }
    if(type == 'officialDocumentSegment'){
      row = this.section.body.details.officialDocumentSegment.officialDocument[this.section.body.details.officialDocumentSegment.officialDocument.length - 1]
    }
    if(type == 'originalAddressSegment'){
      row = this.section.body.details.originalAddressSegment.originalAddress[this.section.body.details.originalAddressSegment.originalAddress.length - 1]
    }
    if(type == 'contactInformationSegment'){
      row = this.section.body.details.contactInformationSegment.contactInformation[this.section.body.details.contactInformationSegment.contactInformation.length - 1]
    }
    if(type == 'professionalCertificateSegment'){
      row = this.section.body.details.professionalCertificateSegment.professionalCertificate[this.section.body.details.professionalCertificateSegment.professionalCertificate.length - 1]
    }
    let obj = {
      type: type,
      row: row,
  ...
  translateLabel(type) {
    ...
    if (type == 'qualificationSegment' || type =='editqualificationSegment') {
      this.popupLabel = this.i18n.translate('qualification')
    }
    if (type == 'officialDocumentSegment' || type =='editofficialDocumentSegment') {
      this.popupLabel = this.i18n.translate('officialDocumentSegment')
    }
    if (type == 'originalAddressSegment' || type =='editoriginalAddressSegment') {
      this.popupLabel = this.i18n.translate('originalAddress')
    }
    if (type == 'contactInformationSegment' || type =='editcontactInformationSegment') {
      this.popupLabel = this.i18n.translate('contactInformation')
    }
    if (type == 'contactInformationSegment' || type =='editcontactInformationSegment') {
      this.popupLabel = this.i18n.translate('contactInformation')
    }
    if (type == 'professionalCertificateSegment' || type =='editprofessionalCertificateSegment') {
      this.popupLabel = this.i18n.translate('professionalCertificate')
    }
    if (type == 'medicalDetailsSegment' || type =='editmedicalDetailsSegment') {
      this.popupLabel = this.i18n.translate('medicalDetail')
    }
    if (type == 'termsAndConditions') {
      this.popupLabel = this.i18n.translate('termsAndConditions')
    }
  }
  ...
  close() {
    let ind
    if (this.index == null) {
      if (this.type == 'previousExperience') {
        ind = this.section.body.details['previousExperienceSegment']['previousExperience'].length - 1
      }
      if (this.type == 'qualificationSegment') {
        ind = this.section.body.details['qualificationSegment']['qualification'].length - 1
      }
      if (this.type == 'nationalAddressSegment') {
        ind = this.section.body.details['nationalAddressSegment']['nationalAddress'].length - 1
      }
      if (this.type == 'officialDocumentSegment') {
        ind = this.section.body.details['officialDocumentSegment']['officialDocument'].length - 1
      }
      if (this.type == 'originalAddressSegment') {
        ind = this.section.body.details['originalAddressSegment']['originalAddress'].length - 1
      }
      if (this.type == 'contactInformationSegment') {
        ind = this.section.body.details['contactInformationSegment']['contactInformation'].length - 1
      }
      if (this.type == 'professionalCertificateSegment') {
        ind = this.section.body.details['professionalCertificateSegment']['professionalCertificate'].length - 1
      }
    ...
    if (this.type == 'nationalAddressSegment') {
      this.deleteGenericRow('nationalAddressSegment', 'nationalAddress', ind)
    }
    if (this.type == 'officialDocumentSegment') {
      this.deleteGenericRow('officialDocumentSegment', 'officialDocument', ind)
    }
    if (this.type == 'originalAddressSegment') {
      this.deleteGenericRow('originalAddressSegment', 'originalAddress', ind)
    }
    if (this.type == 'contactInformationSegment') {
      this.deleteGenericRow('contactInformationSegment', 'contactInformation', ind)
    }
    if (this.type == 'professionalCertificateSegment') {
      this.deleteGenericRow('professionalCertificateSegment', 'professionalCertificate', ind)
    }
  ...
  constructor(
    ...
    public _messageService: ListenerService,
